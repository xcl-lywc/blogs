...
features: # 可选的
  - title: 前端
    ...
    link: /web/ # 可选
    imgUrl: img/docs/web.png # 可选
  - title: 页面
    details: html(5)/css(3)，前端页面相关技术
    link: /ui/
    imgUrl: img/docs/ui.png
  - title: 技术
    details: 技术文档、教程、技巧、总结等文章
    link: /technology/
    imgUrl: img/docs/other.png
...
<!-- 小熊猫 -->
<!-- <img src="img/docs/panda-waving.png" class="panda no-zoom" style="width: 130px;height: 115px;opacity: 0.8;margin-bottom: -4px;padding-bottom:0;position: fixed;bottom: 0;left: 0.5rem;z-index: 1;"> -->
